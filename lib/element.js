...
export default class Element {
  ...
  parent() {
    if (this._parent === undefined) {
      ...
      this._parent = element ? this._get(element) : null;
    }
  ...
  next() {
    if (this._next === undefined) {
      ...
      this._next = element ? this._get(element) : null;
    }
  ...
  prev() {
    if (this._prev === undefined) {
      ...
      this._prev = element ? this._get(element) : null;
    }
  ...
  bounds(pseudo = Pseudo.DEFAULT) {
    ...
    if (this._bounds[pseudo] === undefined) {
      this._bounds[pseudo] = this.simulate(pseudo, () =>
  ...
  offset(pseudo = Pseudo.DEFAULT) {
    ...
    if (this._offset[pseudo] === undefined) {
      this._offset[pseudo] = this.simulate(pseudo, () =>
        $.offset(this._element)
      );
    }
  ...
  position(pseudo = Pseudo.DEFAULT) {
    ...
    if (this._position[pseudo] === undefined) {
      this._position[pseudo] = this.simulate(pseudo, () =>
  ...
  css(property, pseudo = Pseudo.DEFAULT) {
    ...
    return this._css[pseudo].get(property, () =>
      this.simulate(pseudo, () => this.style()[property])
    );
  }
  ...
  find(selector) {
    ...
    return this._find.get(selector, () => {
      ...
      return element ? this._get(element) : null;
    });
  }
